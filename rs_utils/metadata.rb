...
recipe "rs_utils::install_postgresql_collectd_plugin", "Installs the postgresql collectd plugin for monitoring support."
...
attribute "rs_utils/process_list",
  ...
  :required => "optional",
  :default => "",
  :recipes => [ "rs_utils::install_mysql_collectd_plugin", "rs_utils::install_postgresql_collectd_plugin", "rs_utils::setup_monitoring", "rs_utils::default" ]
